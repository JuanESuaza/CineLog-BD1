...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Catálogo unificado de películas y series';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `CONTENIDO` VALUES (1,'Avengers: Endgame','Película',2019,'Los Vengadores sobrevivientes se unen para revertir el chasquido de Thanos y restaurar el universo.','Inglés','https://placeholder.com/endgame.jpg','2026-01-01'),(2,'Avengers: Infinity War','Película',2018,'Los Vengadores y sus aliados deben estar dispuestos a sacrificarlo todo para derrotar al poderoso Thanos.','Inglés','https://placeholder.com/infinitywar.jpg','2026-01-01'),(3,'Iron Man','Película',2008,'El empresario Tony Stark construye una armadura de alta tecnología y se convierte en el superhéroe Iron Man.','Inglés','https://placeholder.com/ironman.jpg','2026-01-01'),(4,'Oppenheimer','Película',2023,'La historia del físico J. Robert Oppenheimer y su papel en el desarrollo de la bomba atómica durante la Segunda Guerra Mundial.','Inglés','https://placeholder.com/oppenheimer.jpg','2026-01-01'),(5,'Dune: Parte Uno','Película',2021,'Paul Atreides, un joven brillante, viaja al planeta más peligroso del universo para proteger a su familia.','Inglés','https://placeholder.com/dune1.jpg','2026-01-01'),(6,'Dune: Parte Dos','Película',2024,'Paul Atreides se une a los Fremen y comienza un viaje espiritual y político para convertirse en Muad\'Dib.','Inglés','https://placeholder.com/dune2.jpg','2026-01-01'),(7,'El Señor de los Anillos: La Comunidad del Anillo','Película',2001,'El hobbit Frodo Bolsón hereda el Anillo Único y emprende un viaje para destruirlo.','Inglés','https://placeholder.com/lotr1.jpg','2026-01-01'),(8,'El Señor de los Anillos: Las Dos Torres','Película',2002,'La Comunidad del Anillo se divide mientras la guerra de los Reinos de los Hombres avanza.','Inglés','https://placeholder.com/lotr2.jpg','2026-01-01'),(9,'El Señor de los Anillos: El Retorno del Rey','Película',2003,'La batalla final por la Tierra Media determina el destino de todos sus habitantes.','Inglés','https://placeholder.com/lotr3.jpg','2026-01-01'),(10,'Knives Out','Película',2019,'Un detective investiga la muerte de un famoso escritor tras la reunión familiar en su mansión.','Inglés','https://placeholder.com/knivesout.jpg','2026-01-01'),(11,'The Last of Us','Serie',2023,'En un mundo post-apocalíptico devastado por una infección fúngica, Joel debe escoltar a Ellie a través de los peligros de los Estados Unidos.','Inglés','https://placeholder.com/tlou.jpg','2026-01-01'),(12,'Euphoria','Serie',2019,'Sigue a un grupo de adolescentes mientras navegan por las drogas, el amor, la identidad y el trauma.','Inglés','https://placeholder.com/euphoria.jpg','2026-01-01'),(13,'The Mandalorian','Serie',2019,'Un guerrero mandaloriano viaja por la galaxia protegiendo a un misterioso niño de la especie del Maestro Yoda.','Inglés','https://placeholder.com/mandalorian.jpg','2026-01-01'),(14,'The Queen\'s Gambit','Serie',2020,'Una joven huérfana se convierte en una prodigiosa jugadora de ajedrez mientras lucha contra su adicción a las drogas.','Inglés','https://placeholder.com/queensgambit.jpg','2026-01-01'),(15,'Severance','Serie',2022,'Los empleados de una corporación se someten a un procedimiento que separa sus recuerdos laborales de los personales.','Inglés','https://placeholder.com/severance.jpg','2026-01-01');
...
INSERT INTO `CONTENIDO_GENERO` VALUES (1,1),(2,1),(3,1),(13,1),(1,2),(2,2),(5,2),(6,2),(7,2),(8,2),(9,2),(13,2),(1,3),(2,3),(3,3),(5,3),(6,3),(11,3),(13,3),(15,3),(4,4),(7,4),(8,4),(9,4),(11,4),(12,4),(14,4),(15,4),(12,5),(4,7),(10,7),(11,7),(14,7),(15,7),(5,9),(6,9),(7,9),(8,9),(9,9),(10,11);
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Géneros cinematográficos y televisivos';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `GENERO` VALUES (1,'Acción'),(8,'Animación'),(2,'Aventura'),(3,'Ciencia Ficción'),(5,'Comedia'),(11,'Crimen'),(12,'Documental'),(4,'Drama'),(9,'Fantasía'),(10,'Romance'),(13,'Suspenso'),(6,'Terror'),(7,'Thriller');
...
INSERT INTO `PELICULA` VALUES (1,181),(2,149),(3,126),(4,180),(5,155),(6,166),(7,178),(8,179),(9,201),(10,130);
...
-- Dump completed on 2026-05-17 13:59:46
