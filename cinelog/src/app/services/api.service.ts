...
export class ApiService {
  ...
  // Calificaciones
  getCalificacion(idContenido: number): Observable<any> { return this.http.get(`${this.base}/calificaciones/${idContenido}`, { headers: this.headers() }); }
  guardarCalificacion(data: any): Observable<any> { return this.http.post(`${this.base}/calificaciones`, data, { headers: this.headers() }); }
  ...
  getFinal(idContenido: number): Observable<any> { return this.http.get(`${this.base}/finales/${idContenido}`, { headers: this.headers() }); }
  getTodosFinales(idContenido: number): Observable<any> { return this.http.get(`${this.base}/finales/${idContenido}/todos`); }
  guardarFinal(data: any): Observable<any> { return this.http.post(`${this.base}/finales`, data, { headers: this.headers() }); }
